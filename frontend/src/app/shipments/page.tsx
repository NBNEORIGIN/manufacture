    ...
    <div>
      ...
      {showForm && (
        <div className="bg-white rounded-lg shadow p-4 mb-6 flex items-center gap-4">
          ...
          <button onClick={createShipment} className="bg-green-600 text-white px-4 py-2 rounded text-sm hover:bg-green-700">
            Create
          </button>
          ...
          {selected && (
            <div className="bg-white rounded-lg shadow p-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-lg font-semibold">FBA-{selected.id} — {selected.country}</h3>
