    ...
    >
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Personalised orders auto-dispatch at import time — they ship via
              the memorial app + Zenstores, never need a button click in this
              app. Visible on the All tab with a violet badge for verification. */}
